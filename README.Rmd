...
1. Data (salinity, temperature, salinity) is be supplied from all sensors at the lock. The data includes salinity readings.
...
2. Animate the TIME block to show the time readings are they are animated
...
## Guthorm Maersk
The first visualization was ran only using data from lockage of the Guthorm Maersk ship.
