...
5. Make more effective use of functions. Currently chunks are run in for loops but could be more organized if utilizing functions for tasks. It is not currently known if this would improve current runtime to create all models
