...
Check out the temperature and pressure readings
```{R}
...
Create a loop that will run through each ship and create images.
```{R}
svg_total <- minisvg::parse_svg_doc("man/figures/total_lock_cross_section.svg")
